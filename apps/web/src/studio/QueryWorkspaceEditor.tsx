...
export function QueryWorkspaceEditor({ value, onValueChange, activeTab }: QueryWorkspaceEditorProps) {
    return (
        <div className="flex-[0.45] min-h-[200px] overflow-y-auto border-b border-white/5 bg-[#0d1117] group relative">
